...
class ThreadWorkflowSynchronizer:
    """
    Dedicated core class for evaluating and synchronizing thread workflow_status
    whenever task lifecycle events (create, update, delete) occur or drafts are saved/sent.
