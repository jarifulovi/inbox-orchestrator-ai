...
from app.core.ml_models.action_extractor.components.action_detector import ActionDetector
from app.core.ml_models.action_extractor.components.ownership_detector import OwnershipDetector
